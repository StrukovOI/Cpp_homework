...
public:
    MultiCommand(std::vector<Command*> v) : mCmds(v) {}
...
int main()
{
    ...
    vCmds.push_back(new RandAllColCmd(pool));
    vCmds.push_back(new RandomAllPositionsCommand(pool));
    control.addButton(new Button({40, 560, 240, 40}, "Multi: Color + Pos"), new MultiCommand(vCmds));
